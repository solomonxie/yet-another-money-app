...
export const zh: Record<keyof typeof en, string> = {
  ...
  'scheduledTransactionModal.repeatLabel': '重复',
  ...
  'repeatField.customTitle': '自定义',
  'repeatField.presetDaily': '每天',
  'repeatField.presetWeekdays': '工作日',
  'repeatField.presetWeekends': '周末',
  'repeatField.presetWeekly': '每周',
  'repeatField.presetBiweekly': '每两周',
  'repeatField.presetMonthly': '每月',
  'repeatField.presetEvery3Months': '每 3 个月',
  'repeatField.presetEvery6Months': '每 6 个月',
  'repeatField.presetYearly': '每年',
  'repeatField.custom': '自定义…',
