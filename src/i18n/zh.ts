...
export const zh: Record<keyof typeof en, string> = {
  ...
  'trackingValueModal.gainLabel': '距上次记录的盈亏',
  ...
  'scheduledTransactionModal.newTitle': '新建定期交易',
  'scheduledTransactionModal.editTitle': '编辑定期交易',
  'scheduledTransactionModal.amountLabel': '金额',
  'scheduledTransactionModal.memoLabel': '备注',
  'scheduledTransactionModal.scheduleHeading': '周期设置',
  'scheduledTransactionModal.frequencyLabel': '频率',
  'scheduledTransactionModal.frequencyWeekly': '每周',
  'scheduledTransactionModal.frequencyMonthly': '每月',
  'scheduledTransactionModal.frequencyYearly': '每年',
  'scheduledTransactionModal.intervalLabel': '每隔几个周期',
  'scheduledTransactionModal.nextDateLabel': '下次日期',
  'scheduledTransactionModal.hasEndDateLabel': '设置结束日期',
  'scheduledTransactionModal.endDateLabel': '结束日期',
  'scheduledTransactionModal.postingLabel': '记账方式',
  'scheduledTransactionModal.manualApprove': '手动确认',
  'scheduledTransactionModal.autoPost': '自动记账',
  'scheduledTransactionModal.deleteSchedule': '删除定期交易',
  'scheduledTransactionModal.deleteConfirmTitle': '删除此定期交易？',
