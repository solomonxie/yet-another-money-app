...
export const en = {
  ...
  'scheduledTransactionModal.newTitle': 'New Schedule',
  'scheduledTransactionModal.editTitle': 'Edit Schedule',
  'scheduledTransactionModal.amountLabel': 'Amount',
  'scheduledTransactionModal.memoLabel': 'Memo',
  'scheduledTransactionModal.scheduleHeading': 'Schedule',
  'scheduledTransactionModal.repeatLabel': 'Repeat',
  'scheduledTransactionModal.nextDateLabel': 'Next Date',
  'scheduledTransactionModal.hasEndDateLabel': 'Ends on a date',
  'scheduledTransactionModal.endDateLabel': 'End Date',
  'scheduledTransactionModal.postingLabel': 'Posting',
  'scheduledTransactionModal.manualApprove': 'Manual Approve',
  'scheduledTransactionModal.autoPost': 'Auto-Post',
  'scheduledTransactionModal.deleteSchedule': 'Delete Schedule',
  'scheduledTransactionModal.deleteConfirmTitle': 'Delete this schedule?',

  'repeatField.title': 'Repeat',
  'repeatField.customTitle': 'Custom',
  'repeatField.presetDaily': 'Daily',
  'repeatField.presetWeekdays': 'Weekdays',
  'repeatField.presetWeekends': 'Weekends',
  'repeatField.presetWeekly': 'Weekly',
  'repeatField.presetBiweekly': 'Biweekly',
  'repeatField.presetMonthly': 'Monthly',
  'repeatField.presetEvery3Months': 'Every 3 Months',
  'repeatField.presetEvery6Months': 'Every 6 Months',
  'repeatField.presetYearly': 'Yearly',
  'repeatField.custom': 'Custom…',
